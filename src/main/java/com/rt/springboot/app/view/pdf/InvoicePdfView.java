...
public class InvoicePdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		cell = new PdfPCell(new Phrase("Inovice Data"));
		cell.setBackgroundColor(new Color(195, 230, 203));
		cell.setPadding(8f);
		table2.addCell(cell);
		table2.addCell("Invoice Number"+ ": " + invoice.getId());
		table2.addCell("Bill Month"+ ": " + invoice.getDescription());
		...
		table3.addCell("Slab");
		table3.addCell("Charge per unit");
		table3.addCell("Units used");
